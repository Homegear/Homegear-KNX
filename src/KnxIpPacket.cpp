...
std::string KnxIpPacket::getServiceIdentifierString()
{
    switch(_serviceType)
    {
        ...
        case ServiceType::CONFIG_REQUEST:
            return "CONFIG_REQUEST";
        case ServiceType::CONFIG_ACK:
            return "CONFIG_ACK";
